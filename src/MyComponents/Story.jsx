...
function Story() {
  ...
  let data = [
    ...
    {
      source:
        "https://i.pinimg.com/736x/8f/49/b0/8f49b0f5229b6fceff12a14a7fa03e51.jpg",
      title: "Taylor Swift",
    },
    {
      source:
        "https://maherzi.com/wp-content/uploads/2022/03/magenta3-1-683x1024.jpg ",
      title: "Mark Bryan",
    },
    {
      source:
        "https://images.unsplash.com/photo-1591624739238-f2b789898aa7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE2fHx8ZW58MHx8fHw%3D&w=1000&q=80",
      title: "Dua Lipa",
    },
    {
      source:
        "https://i.pinimg.com/564x/46/60/b5/4660b5babf0a7caedd3d999967588c1e.jpg",
      title: "Anne Marie",
    },
  ];
  ...
  return (
    <React.Fragment>
      <div style={{ display: "flex", maxWidth: "700px", overflowX: "hidden" }}>
        {data.map((data) => {
          return <Stcontent source={data.source} title={data.title} />;
        })}
      </div>
    </React.Fragment>
  );
